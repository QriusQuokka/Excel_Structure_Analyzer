...
_STYLE = """
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card-header .toggle-icon { margin-left:auto; font-size:.85rem; color:#8a97a6; transition:transform .2s; }
  ...
  .formula-sheet-header .toggle-icon { font-size:.8rem; color:#8a97a6; transition:transform .2s; }
